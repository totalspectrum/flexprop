...
int fixup_argv(int *argc, TCHAR ***argv)
{
    ...
    my_argv[1] =  dyn_strcat(namebuffer, TEXT("/src/flexprop.tcl"));
    ...
    *argv = my_argv;
    ...
    _tputenv_s(TEXT("TCL_LIBRARY"), dyn_strcat(namebuffer, TEXT("/tcl_library/tcl8.6")));
    _tputenv_s(TEXT("TK_LIBRARY"), dyn_strcat(namebuffer, TEXT("/tcl_library/tk8.6")));
    return 0;
}      

/*
